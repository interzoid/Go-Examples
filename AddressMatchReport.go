...
func main() {
	...
	ifile, err := os.Open("addresses.csv")
	...
	for value := range result {
		...
		url := "https://api.interzoid.com/getaddressmatchadvanced?license=YOURAPIKEY&address=" + url2.QueryEscape(result[value][0]) + "&algorithm=narrow"
		...
		appendValue.address = result[value][0]
